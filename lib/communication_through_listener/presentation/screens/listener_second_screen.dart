...
class ListenerSecondScreen extends StatefulWidget {
  const ListenerSecondScreen({
    super.key,
    this.title = "",
  ...
  State<StatefulWidget> createState() {
    return _ListenerSecondScreen(appTitle: this.title);
  }
}

class _ListenerSecondScreen extends State<ListenerSecondScreen> {
  final String appTitle;
  _ListenerSecondScreen({required this.appTitle});
